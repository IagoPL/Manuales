...
3. [Tests, documentación y lineage](03-tests-documentacion-y-lineage.md)
...
Este capítulo deja el mapa del proyecto. [Sources, models y refs](02-sources-models-y-refs.md) baja a `source()`, `ref()` y el DAG.
