...
Este capitulo profundiza en **Rendimiento** dentro del manual de **Pandas**. El objetivo es que entiendas el concepto, lo apliques con ejemplos y evites errores frecuentes en entornos reales.
...
- **Rendimiento:** pieza central de Pandas en este capitulo.
...
Continua con [Proyecto De Analisis](09-proyecto-de-analisis.md).
