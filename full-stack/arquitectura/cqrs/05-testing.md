...
Este capitulo profundiza en **Testing** dentro del manual de **CQRS**. El objetivo es que entiendas el concepto, lo apliques con ejemplos y evites errores frecuentes en entornos reales.
...
- **Testing:** pieza central de CQRS en este capitulo.
...
Continua con [Trade Offs](06-trade-offs.md).
