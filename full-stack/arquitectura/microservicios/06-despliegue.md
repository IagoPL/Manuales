...
Este capitulo profundiza en **Despliegue** dentro del manual de **microservicios**. El objetivo es que entiendas el concepto, lo apliques con ejemplos y evites errores frecuentes en entornos reales.
...
- **Despliegue:** pieza central de microservicios en este capitulo.
...
Continua con [Trade Offs](07-trade-offs.md).
