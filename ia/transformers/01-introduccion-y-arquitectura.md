...
Este capitulo profundiza en **Introduccion Y Arquitectura** dentro del manual de **Transformers**. El objetivo es que entiendas el concepto, lo apliques con ejemplos y evites errores frecuentes en entornos reales.
...
- **Introduccion Y Arquitectura:** pieza central de Transformers en este capitulo.
...
Continua con [Tokenizacion Y Embeddings](02-tokenizacion-y-embeddings.md).
